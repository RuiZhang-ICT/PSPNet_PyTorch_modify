...
def configure_dataset_init_model(args):
    if args.dataset == 'voc12':
        ...
        args.data_dir = '/home/sherryzhang/datasets/Cityscapes'   # Path to the directory containing the PASCAL VOC dataset
        ...
        args.resume = './snapshots/cityscapes/psp_cityscapes.pth' #checkpoint log file, helping recovering training
